...
public class ServidorTocToc {
    public static void main(String[] args) throws IOException {
        ...
        try {
            // el socket se abre en un puerto
        ...
        // declaramos dos variables que sirven para almacenar temporalmente lo que se
        // lee
        ...
        // en este caso es un nulo , y recibimos la respuesta de Protocolo en una cadena
        // de texto
        LineaDeSalida = ptt.processInput(null);
        // imprimimos en el escritor el contenido de la variable LineaSalida (respuesta
        // del Protocolo)
        ...
        while ((LineaDeEntrada = LectorEntrada.readLine()) != null) {
            ...
            // para que nos indique que debemos responder y la respuesta la guardamos en
            // LineaDeSalida
            LineaDeSalida = ptt.processInput(LineaDeEntrada);
            // escribimos la respuesta en el escritor del Socket
            EscritorSalida.println(LineaDeSalida);
            // ahora ya que lo escribimos verificamos si es un Adios y procedemos a cerrar
            // todo
